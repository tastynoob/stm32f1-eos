...
void RCC_PREDIV1Config(uint32_t RCC_PREDIV1_Source, uint32_t RCC_PREDIV1_Div) {
  ...
  /* Check the parameters */
  (IS_RCC_PREDIV1_SOURCE(RCC_PREDIV1_Source));
  (IS_RCC_PREDIV1(RCC_PREDIV1_Div));
...
void RCC_PREDIV2Config(uint32_t RCC_PREDIV2_Div) {
  ...
  /* Check the parameters */
  (IS_RCC_PREDIV2(RCC_PREDIV2_Div));
...
void RCC_OTGFSCLKConfig(uint32_t RCC_OTGFSCLKSource) {
  /* Check the parameters */
  (IS_RCC_OTGFSCLK_SOURCE(RCC_OTGFSCLKSource));
...
void RCC_I2S2CLKConfig(uint32_t RCC_I2S2CLKSource) {
  /* Check the parameters */
  (IS_RCC_I2S2CLK_SOURCE(RCC_I2S2CLKSource));
...
void RCC_I2S3CLKConfig(uint32_t RCC_I2S3CLKSource) {
  /* Check the parameters */
  (IS_RCC_I2S3CLK_SOURCE(RCC_I2S3CLKSource));
  ...
  switch (tmp) {
    ...
    case 0x08:  /* PLL used as system clock */
      ...
      if (pllsource == 0x00) {/* HSI oscillator clock divided by 2 selected as PLL clock entry */
        ...
        if (prediv1source == 0) { /* HSE oscillator clock selected as PREDIV1 clock entry */
          RCC_Clocks->SYSCLK_Frequency = (HSE_VALUE / prediv1factor) * pllmull;
        }
...
void RCC_AHBPeriphResetCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState) {
  /* Check the parameters */
  (IS_RCC_AHB_PERIPH_RESET(RCC_AHBPeriph));
  ((NewState));
